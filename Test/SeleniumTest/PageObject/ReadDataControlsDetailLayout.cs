...
{
    public class ReadDataControlsDetailLayout : ComponentBase
    {
        ...
        public static implicit operator ReadDataControlsDetailLayout(ElementFinder finder) => finder.Find<ReadDataControlsDetailLayout>();
    }

    public class ReadDataControlsDetailPage : DetailPage<ReadDataControlsDetailLayout>
    {

        public ReadDataControlsDetailPage(IWebDriver driver) : base(driver) { }

    }

    public static class ReadDataControlsDetailPageExtensions
    {

        [PageObjectIdentify(UrlCompareType.Contains, "/ReadDataControls/")]
        public static ReadDataControlsDetailPage AttachReadDataControlsDetailPage(this IWebDriver driver)
        {
            driver.WaitForUrl(UrlCompareType.Contains, "/ReadDataControls/");
            return new ReadDataControlsDetailPage(driver);
        }

        [ComponentObjectIdentify]
        public static ModuleDialogDriver<ReadDataControlsDetailLayout> AttachReadDataControlsDialog(this IWebDriver driver)
            => new MappingBase(driver).ByCssSelector("[data-system='module-dialog'][data-module-design='ReadDataControls']").Wait();
