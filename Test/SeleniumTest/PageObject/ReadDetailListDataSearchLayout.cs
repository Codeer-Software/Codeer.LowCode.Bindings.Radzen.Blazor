...
{
    public class ReadDetailListDataSearchLayout : ComponentBase
    {
        ...
        public DetailListFieldSearchDriver List => ByCssSelector("div[data-name='List']").Wait();
        ...
        public ReadDetailListDataSearchLayout(IWebElement element) : base(element) { }

        public static implicit operator ReadDetailListDataSearchLayout(ElementFinder finder) => finder.Find<ReadDetailListDataSearchLayout>();
    }
