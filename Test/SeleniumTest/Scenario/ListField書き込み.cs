...
public class ListField書き込み
{
    ...
    public void SetUp()
    {
        DataManager.DeleteWriteListDataControls();
        _driver = WebDriverManager.Driver;
        _driver.Url = WebDriverManager.Domain + "/Main/WriteListData";
    }
    ...
    public void CheckBox()
    {
        ...
        WebDriverManager.WaitLoading();
        var writeListDataListPage1 = _driver.AttachWriteListDataListPage();
        ...
        //一覧に戻る
        _driver.AttachMainLeft().WriteListData.Click();
        var writeListDataListPage2 = _driver.AttachWriteListDataListPage();
        WebDriverManager.WaitLoading();
        writeListDataListPage1.List.Items.Count.Is(1);
    ...
    public void RadioGroup()
    {
        ...
        writeListDataDetailPage.Detail.List.Create.Click();
        writeListDataDetailPage.Detail.List.Items.GetItem(0).RadioA.Input.Element.Click();
        writeListDataDetailPage.Detail.SubmitButton.Submit.Click();
        WebDriverManager.WaitLoading();
        ...
        writeListDataDetailPage2.Detail.List.Items.GetItem(0).RadioB.Input.Element.Click();
        writeListDataDetailPage2.Detail.SubmitButton.Submit.Click();
        WebDriverManager.WaitLoading();
