...
public class DetailListField書き込み
{
    ...
    public void SetUp()
    {
        DataManager.DeleteWriteDetailListDataControls();
        _driver = WebDriverManager.Driver;
        _driver.Url = WebDriverManager.Domain + "/Main/WriteDetailListData";
    }
    ...
    {
        var writeListDataListPage = _driver.AttachWriteDetailListDataListPage();
        writeListDataListPage.Create.Click();

        //作成
        var writeListDataDetailPage = _driver.AttachWriteDetailListDataDetailPage();
        ...
        WebDriverManager.WaitLoading();
        var writeListDataListPage1 = _driver.AttachWriteDetailListDataListPage();
        ...
        //一覧に戻る
        _driver.AttachMainLeft().WriteDetailListData.Click();
        var writeListDataListPage2 = _driver.AttachWriteDetailListDataListPage();
        WebDriverManager.WaitLoading();
        writeListDataListPage1.List.Items.Count.Is(1);
